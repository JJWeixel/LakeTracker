    ...
    return (
        <SidebarProvider>
            ...
            <main className="h-full w-full m-4">
                <SidebarTrigger/>
                <HomeHeader />
                    <div className="w-full pt-4 flex grow flex-col text-5xl gap-4 items-center">
                        ...
                        <div className="h-40 w-7/8 flex flex-row gap-4 justify-between">
                            <div className="h-40 w-1/2 flex flex-row border bg-accent rounded-2xl justify-between px-8 items-center">
                                <div className="text-3xl">Compass Bar</div>
                                <div className="h-full flex flex-col items-center py-4 justify-between">
                            ...
                            <div className="h-40 w-1/2 flex flex-row border bg-accent rounded-2xl justify-between px-8 items-center">
                                ...
                                <div className="h-full w-40 flex flex-col items-center py-4 justify-between">
